window.onload = ()=>{
    document.getElementById('repoSocial').addEventListener('click', ()=>{
        window.location.href = "https://github.com/cyntthiah/socialnetworkfemmes";
    ...
    document.getElementById('demoNpm').addEventListener('click' ,()=>{
        window.location.href = "https://www.npmjs.com/package/cynthia-md-links";

    });


    document.getElementById('repoData').addEventListener('click' ,()=>{
    window.location.href = "https://github.com/cyntthiah/scl-2018-05-bc-core-pm-datadashboard";
});
